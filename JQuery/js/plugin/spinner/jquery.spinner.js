...
;(function($){
  ...
  Spinning.rules = {
    ...
    hour12: { min: 1, max: 12, step: 1, precision: 0 },
    downloadDuration:   {min: 5, max: 120, step: 1, precision:0},
    minute: { min: 0, max: 59, step: 1, precision: 0 },
    minute12:   { min: 0, max: 59, step: 1, precision: 0 },
    yearDays: { min: 1, max: 365, step: 1, precision: 0 },
    yearWeeks: { min: 1, max: 52, step: 1, precision: 0 },
    monthDays: {min: 1, max: 31, step: 1, precision:0},
    second: { min: 0, max: 59, step: 1, precision: 0 },
    dateFilter: { min: 1, max: 31, step: 1, precision: 0 }
  };
