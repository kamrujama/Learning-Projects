...
function SOAPClientParameters(method)
{
    var _pl = new Array();
    var _sl = new Array();
    ...
    this.toXml = function()
    {
        ...
        for(var p in _pl)
        {
            switch(typeof(_pl[p]))
            {
                ...
                case "boolean":
                case "object":
                    xml += SOAPClientParameters._serialize(p, _pl[p],false,method);
                    break;
                default:
                    break;
            }
...
SOAPClientParameters._serialize = function (t, o, isNamespaceRequired, method)
{
    var s = "";
    switch(typeof(o))
    {
        case "string":
            if (!isNamespaceRequired) {
                ...
                if (t == "DestinationPath" || t == "ModelId" || t == "ModelName") {

                    s += "<tns:" + t + ">";
                    s += o;//.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
                    s += "</tns:" + t + ">";
                } else {
                    if (t == "TempFilePath" || t == "ThumbData" || t == "TruncatedSoftwareFileName" || t == "Type" || t == "FileData") {
                        
                       
                        s += "<tns:" + t + " xmlns:tns=\"http://schemas.datacontract.org/2004/07/VHQBusinessLayer\">";
                        s += o;//.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
                        s += "</tns:" + t + ">";
                    } else {
                        if (method == "validbundle") {
                            s += "<tns:" + t + " xmlns:tns=\"http://schemas.datacontract.org/2004/07/VHQBusinessLayer\">";
                            s += o;//.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
                            s += "</tns:" + t + ">";

                        } else {
                            s += "<tns:" + t + " xmlns:tns=\"http://schemas.datacontract.org/2004/07/VHQDataAccessLayer.Entities\">";
                            s += o;//.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
                            s += "</tns:" + t + ">";
                        }
                    }
...
//            }
        ...
        case "object":
            // Date
            if(o!= null && o.constructor.toString().indexOf("function Date()") > -1)
            {
            ...
            // Array
            else if (o != null && o.constructor.toString().indexOf("function Array()") > -1) {
                ...
                for (var p in o) {
                    if (!isNaN(p))   // linear array
                    {
                        ...
                        s += SOAPClientParameters._serialize("EModel", o[p], true, method);
                    }
                    else    // associative array
                    {
                        SOAPClientParameters._serialize("item", o[p], true, method);
                    }
                }
                s += "</tns:" + t + ">";
            }
                ...
                if (o == null) {
                    //s += "<tns:" + t + "  xsi:nil=\"true\" xmlns:tns=\"http://schemas.datacontract.org/2004/07/VHQBusinessLayer\"/>";
                    if (t == 'object') {

                        s += "<tns:" + t + " xsi:nil=\"true\" xmlns:tns=\"http://schemas.datacontract.org/2004/07/VHQBusinessLayer\"/>";       
                    }
                    else {
                        if (t == "TempFilePath" || t == "ThumbData") {
                            s += "<tns:" + t + " xsi:nil=\"true\" xmlns:tns=\"http://schemas.datacontract.org/2004/07/VHQBusinessLayer\"/>";
                        } else {
                            if (t == "Applications") {
                                s += "<tns:" + t + " xmlns:tns=\"http://schemas.datacontract.org/2004/07/VHQDataAccessLayer.Entities\"/>";
                            } else {
                                s += "<tns:" + t + " xsi:nil=\"true\" xmlns:tns=\"http://schemas.datacontract.org/2004/07/VHQDataAccessLayer.Entities\"/>";
                            }
                        }
                    }
                } else {
                    ...
                    for (var p in o) {
                        ...
                        s += SOAPClientParameters._serialize(p, o[p], true, method);
...
SOAPClient._sendSoapRequest = function(url, method, parameters, async, callback, wsdl)
{
    ...
    ">" +
    (SOAPClient.auth?"<s:Header><AuthHeader xmlns=\"" + ns + "\">" +
    ...
    var soapaction = ((ns.lastIndexOf("/") != ns.length - 1) ? ns + "/" : ns) + "IDataService/"+method;
...
SOAPClient._node2object = function(node, wsdlTypes)
{
    ...
    if(!isarray)
    {
        ...
        for(var i = 0; i < node.childNodes.length; i++)
        {
            ...
            obj[node.childNodes[i].nodeName.replace(/a:/g, "")] = p;
        }
