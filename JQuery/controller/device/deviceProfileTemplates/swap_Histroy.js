define(["knockout", "koUtil", "autho", "knockout.validation", "jQuery.base64", "constants", "globalFunction", "appEnum"], function (ko, koUtil, autho) {
    ...
    return function downloadLibararyappViewModel() {
        ...
        var compulsoryfields = ['ModifiedByUserName'];
        ...
        self.exportToExcel = function (isExport, gId) {
            var param = getChangehistoryParameters(true, columnSortFilter);
    ...
    function changeHistoryGrid(gID, param) {
        ...
        var dataAdapter = new $.jqx.dataAdapter(source,
            {
                formatData: function (data) {
                    ...
                    columnSortFilter = new Object();
                    columnSortFilter = columnSortFilterFormatedData(columnSortFilter, gID, gridStorage, 'SwapHistoryForDeviceProfile');
        ...
        $("#" + gID).jqxGrid(
        {
            ...
            columns: [
                    ...
                    { text: '', dataField: 'AuditId', hidden: true, editable: false, width: 'auto' },
                    {
                        text: i18n.t('serial', { lng: lang }), dataField: 'SerialNumber', editable: false, minwidth: 200, width: 'auto',
                        filtertype: "custom",
                      ...
                      {
                          text: i18n.t('so_hierarchy_path', { lng: lang }), dataField: 'SwapOutHierarchyPath', editable: false, minwidth: 200, width: 'auto',
                      ...
                      {
                          text: i18n.t('swapped_on', { lng: lang }), datafield: 'SwappedOn', cellsformat: LONG_DATETIME_GRID_FORMAT, minwidth: 180, width: 'auto', filterable: true, editable: false,
                          filtertype: "custom",
                          createfilterpanel: function (datafield, filterPanel) {
    ...
    function getChangehistoryParameters(isExport, columnSortFilter) {
