define(["knockout", "knockout.validation", "jQuery.base64", "constants", "globalFunction", "appEnum", "chosen"], function (ko) {
    ...
    return function getModelJobResult() {
        ...
        //Draggable function
        $('#mdlDownloadJobHeader').mouseup(function () {
            $("#mdlDownloadJob").draggable({ disabled: true });
        });

        $('#mdlDownloadJobHeader').mousedown(function () {
            $("#mdlDownloadJob").draggable({ disabled: false });
        });
        ////////////////
        ...
        self.exportToExcelModel = function (isExport, gridID) {
            ...
            modelLibDownloadJobExport(param);
        }
    ...
    function modelLibDownloadJobExport(param) {
        ...
        $("#" + gID).jqxGrid(
            {
                ...
                columns: [
                    ...
                    {
                        text: i18n.t('device_pack', { lng: lang }), dataField: 'PackageName', filterable: true, editable: false, minwidth: 100,  filtertype: "custom",
                        createfilterpanel: function (datafield, filterPanel) {
                            buildFilterPanelDate(filterPanel, datafield);
                        }
                    },
                    { text: i18n.t('rs_statsus', { lng: lang }), dataField: 'Status', filterable: true, editable: false, minwidth: 120,  },
                    { text: i18n.t('content_description', { lng: lang }), dataField: 'Description', filterable: true, editable: false, minwidth: 130, },
                    {
                        text: i18n.t('download_started_at', { lng: lang }), dataField: 'StartTime', filterable: true, editable: false, minwidth: 150,  cellsrenderer: receivedDateRenderer, filtertype: "custom",
                        createfilterpanel: function (datafield, filterPanel) {
                            buildFilterPanelDate(filterPanel, datafield);
                        }
                    },
                    { text: i18n.t('download_duration', { lng: lang }), dataField: 'DownloadDuration', filterable: true, editable: false, minwidth: 150,  },
                    {
                        text: i18n.t('installed_at', { lng: lang }), dataField: 'InstalledDate', filterable: true, editable: false, minwidth: 160, cellsrenderer: receivedDateRenderer, filtertype: "custom",
                        createfilterpanel: function (datafield, filterPanel) {
                            buildFilterPanelDate(filterPanel, datafield);
                        }
                    },
                    {
                        text: i18n.t('content_file_name', { lng: lang }), dataField: 'File', filterable: true, editable: false, minwidth: 100, 
                        filtertype: "custom",
                        createfilterpanel: function (datafield, filterPanel) {
                            buildFilterPanelDate(filterPanel, datafield);
                        }
                    ...
                    {
                        text: i18n.t('fileSize_mb', { lng: lang }), dataField: 'FileSize', filterable: true, editable: false, minwidth: 100,
                        filtertype: "custom",
                        createfilterpanel: function (datafield, filterPanel) {
                            buildFilterPanelDate(filterPanel, datafield);
                        }
